...
##
## NOTE:
## contexts are: actions, apps, camera, categories, devices, emblems, emotes, legacy, mimetypes, places, status, ui.
...
contexts=( actions apps camera categories devices emblems emotes legacy mimetypes places status ui )
